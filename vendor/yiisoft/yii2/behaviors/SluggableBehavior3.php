 ...
 * @since 2.0
 */
class SluggableBehavior3 extends AttributeBehavior
{
    /**
     * @var string the attribute that will receive the slug value
     */
    public $slugAttribute = 'slug3';
    /**
    ...
    protected function getValue($event)
    {
        ...
        if ($this->attribute !== null) {
            if ($this->isNewSlugNeeded()) {
                ...
                $slug3 = $this->generateSlug($slugParts);
				//echo $slug2;
            } else {
                return $this->owner->{$this->slugAttribute};
            }
        } else {
            $slug3 = parent::getValue($event);
        }

        return $this->ensureUnique ? $this->makeUnique($slug3) : $slug3;
    }
     ...
     * @since 2.0.7
     */
    protected function makeUnique($slug3)
    {
        $uniqueSlug = $slug3;
        $iteration = 0;
     ...
     */
    protected function validateSlug($slug3)
    {
        ...
        $model->clearErrors();
        $model->{$this->slugAttribute} = $slug3;
