...
<div class="gallery-item">
    <div class="image">
        ...
        <a class="image-wrap" href="<?= Url::toRoute(["view", 'id'=>$model->gallery_id,'newsapp_id' => $model->newsapp_id]) ?>">
            <?php
            foreach($model->galleryPhotos as $prevPhoto){
                echo \yii\helpers\Html::img('/img/gallery/' . Translator::rus2translit($model->gallery_name) . '/thumb/' . $prevPhoto->name);
            };
            ?>
        </a>
    </div>
