...
JS
            ...
            echo \yii\bootstrap\Collapse::widget([
                'items' => [
                    [
                        'label' => $model->gallery_name . ' (' . count((array)$photos) . ' photos)',
            ...
            echo Collapse::widget([
                ...
                echo Html::a('<i class="glyphicon glyphicon-repeat"></i>', ['#'],
                    ['title' => 'Reset', 'class' => 'btn btn-default', 'style' => "display:none", 'id' => 'reset-all',
                        'data-toggle' => "tooltip", 'data-placement' => "top", 'data-trigger' => "hover"]);
               echo Html::a('<i class="glyphicon glyphicon-star"></i>', Url::toRoute('add-main'),
                    ['title' => 'Main title', 'class' => 'btn btn-default', 'style' => "display:none", 'id' => 'add-all',
                        'data-toggle' => "tooltip", 'data-placement' => "top", 'data-trigger' => "hover",
						'role' => 'modals-click',
                        'data-modal-title'=>'Main photo',
...
Modal::begin([
    ...
    "footer" =>
        Html::a('Close', ['#'],
            ['title' => 'Cancel', 'class' => 'btn btn-default pull-left', 'data-dismiss' => "modal"]) .
        Html::a('ОК', Url::toRoute(['add-main','newsapp_id'=>$newsapp_id]),
            ['title' => '', 'class' => 'btn btn-primary', 'id' => 'photos-delete-confirm-btn']),
]);
...
$(document).on('ready', function() {
    ...
    uploadExtraData: {
       ...
       'gallery_name': "$model->gallery_name",
    },
    maxFileCount: 1000,
